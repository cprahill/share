...
// cache: game-v79.js  — full-coverage Mars ground, seated STLs, long boost, cooler HUD
const BUILD = "79";
const GATE_COUNT = 5;
const LAP_COUNT = 3;
...
scene.fog = new THREE.Fog(FOG_PEACH, 220, 2100);
...
const camera = new THREE.PerspectiveCamera(52, innerWidth / innerHeight, 0.4, 4200);
scene.add(camera);
...
ground.frustumCulled = false;
{
  ...
  for (let i = 0; i < gpos.count; i++) {
    ...
    gpos.setZ(i, groundH(lx + GROUND_OX, ly + GROUND_OZ));
  }
...
const ribbon = new THREE.Mesh(ribbonGeo, new THREE.MeshStandardMaterial({
  map: DIRT_TRACK, color: RIBBON_PACK, roughness: 0.92, metalness: 0.04,
...
const sky = new THREE.Mesh(
  new THREE.SphereGeometry(2800, 24, 16),
